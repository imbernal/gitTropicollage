...
!function (a) {
    function b(e) {
        ...
        if (l.elem)k = e.dragTarget = l.elem, e.dragProxy = i.proxy || k, e.cursorOffsetX = l.pageX - l.left, e.cursorOffsetY = l.pageY - l.top, e.offsetX = e.pageX - e.cursorOffsetX, e.offsetY = e.pageY - e.cursorOffsetY; else if (i.dragging || l.which > 0 && e.which != l.which || a(e.target).is(l.not))return;
        switch (e.type) {
            case"mousedown":
    ...
    function b(b) {
        function c(a, c) {
            var d = b.offset();
            d.left = a.pageX - d.left, d.top = a.pageY - d.top, c ? b.zoomOut({"center": d}) : b.zoom({"center": d})
        }
        ...
        function f(a) {
            ...
            !m && c && (m = setTimeout(function () {
                b.pan({"left": k - a.pageX, "top": l - a.pageY}), k = a.pageX, l = a.pageY, m = null
            }, 1 / c * 1e3))
        }
        ...
        function h(a, b) {
            var h = a.getOptions();
            h.zoom.interactive && (b[h.zoom.trigger](c), b.mousewheel(d)), h.pan.interactive && (b.bind("dragstart", {"distance": 10}, e), b.bind("drag", f), b.bind("dragend", g))
        }
    ...
    a.plot.plugins.push({"init": b, "options": c, "name": "navigate", "version": "1.3"})
}(jQuery);