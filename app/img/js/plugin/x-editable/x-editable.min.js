...
!function (a) {
    ...
    a.extend(a.fn.editableform.Constructor.prototype, {
        "initTemplate": function () {
            ...
            b.apply(this);
            var c = null === this.input.options.inputclass || this.input.options.inputclass === !1, d = "", e = "text,select,textarea,password,email,url,tel,number,range,time,typeaheadjs".split(",");
