...
!function (context, undefined) {
    ...
    context.Carousel.prototype.plugins.Rotate3D = new Class({
        ...
        options: {
            ...
            // On d�finit le d�part pour la propri�t� z-index
            zIndex: 100,
        ...
        initialize: function (elements, options, carousel) {
            ...
            this.container = document.id(options.container).//brings an element to the front
        ...
        add: function (el) {
            return this.addElement(el).reset()
        },
        ...
        reorder: function (offset) {
            ...
            this.elements.each(function (el, index) {
                el.setStyles(this.getStyles(el, this.getAngle((length + index - offset) % length)))
            }, this);
