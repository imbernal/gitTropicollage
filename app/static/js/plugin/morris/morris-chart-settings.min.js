...
$(document).ready(function () {
    ...
    if ($("#sales-graph").length && Morris.Area({
            ...
            "element": "area-graph",
            "data": [{"x": "2011 Q1", "y": 3, "z": 3}, {"x": "2011 Q2", "y": 2, "z": 0}, {
                "x": "2011 Q3",
                "y": 0,
                "z": 2
            }, {"x": "2011 Q4", "y": 4, "z": 4}],
            ...
            "element": "bar-graph",
            "data": [{"x": "2011 Q1", "y": 0}, {"x": "2011 Q2", "y": 1}, {"x": "2011 Q3", "y": 2}, {
                "x": "2011 Q4",
                "y": 3
            }, {"x": "2012 Q1", "y": 4}, {"x": "2012 Q2", "y": 5}, {"x": "2012 Q3", "y": 6}, {
                "x": "2012 Q4",
                "y": 7
            }, {"x": "2013 Q1", "y": 8}],
            "xkey": "x",
            ...
            "data": [{"x": "2011 Q1", "y": 3, "z": 2, "a": 3}, {
                "x": "2011 Q2",
                "y": 2,
                "z": null,
                "a": 1
            }, {"x": "2011 Q3", "y": 0, "z": 2, "a": 4}, {"x": "2011 Q4", "y": 2, "z": 4, "a": 3}],
            "xkey": "x",
            "ykeys": ["y", "z", "a"],
            "labels": ["Y", "Z", "A"]
    ...
    if ($("#donut-graph").length && Morris.Donut({
            "element": "donut-graph",
            "data": [{"value": 70, "label": "foo"}, {"value": 15, "label": "bar"}, {
                "value": 10,
                "label": "baz"
    ...
    if ($("#non-continu-graph").length) {
        var c = [{"period": "2012-10-01", "licensed": 3407}, {
            "period": "2012-09-30",
            "sorned": 0
            ...
            "licensed": 3248,
            "other": 1e3
        }, {"period": "2012-09-17", "sorned": 0}, {"period": "2012-09-16", "sorned": 0}, {
            "period": "2012-09-15",
            "licensed": 3201,
            "sorned": 656
    ...
    if ($("#non-date-graph").length) {
        var c = [{"elapsed": "I", "value": 34}, {"elapsed": "II", "value": 24}, {
            "elapsed": "III",
            "value": 3
        }, {"elapsed": "IV", "value": 12}, {"elapsed": "V", "value": 13}, {
            "elapsed": "VI",
            "value": 22
        }, {"elapsed": "VII", "value": 5}, {"elapsed": "VIII", "value": 26}, {
            "elapsed": "IX",
            "value": 12
        }, {"elapsed": "X", "value": 19}];
        Morris.Line({
