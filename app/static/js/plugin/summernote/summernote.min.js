...
!function (a) {
    ...
    var b, c = "function" == typeof define && define.amd, d = function (b) {
        ...
        var b = function (b) {
            ...
            if (0 === d)return b(c) ? null : {"node": c.parentNode, "offset": y(c)};
            if (z(c)) {
                var e = c.childNodes[d - 1];
                return {"node": e, "offset": w(e)}
            }
            return {"node": c, "offset": d - 1}
        }, B = function (b, c) {
        ...
        "options": {
            ...
            "codemirror": {"mode": "text/html", "htmlMode": !0, "lineNumbers": !0, "autoFormatOnStart": !1},
            "lang": "en-US",
            "direction": null,
        ...
        var b = !!document.createRange, c = function (a, b) {
            ...
            var b = function (a, c) {
                ...
                return {"cont": d, "collapseToStart": e, "offset": c}
            ...
            var l = function () {
                ...
                var e = d({"cont": c, "offset": i});
                return e.setEndPoint("EndToEnd", d({"cont": j, "offset": k})), e
            };
            this.getBPs = function () {
                return {"sc": c, "so": i, "ec": j, "eo": k}
            }, this.getStartBP = function () {
                return {"node": c, "offset": i}
            }, this.getEndBP = function () {
                return {"node": j, "offset": k}
            ...
            this.isOnEditable = m(h.isEditable), this.isOnList = m(h.isList), this.isOnAnchor = m(h.isAnchor), this.isOnCell = m(h.isCell), this.isCollapsed = function () {
                ...
                return {
                    "s": {"path": h.makeOffsetPath(a, c), "offset": i},
                    "e": {"path": h.makeOffsetPath(a, j), "offset": k}
                }
        ...
        return {
            "create": function (a, d, f, g) {
                if (arguments.length)2 === arguments.length && (f = a, g = d); else if (b) {
        ...
        this.tab = function (a, b) {
            ...
            j.createImage(b).then(function (b) {
                d(a), b.css({"display": "", "width": Math.min(a.width(), b.width())}), m.create().insertNode(b[0])
            }).fail(function () {
            ...
            d(b);
            var e, f = /^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|\&v=)([^#\&\?]*).*/, g = c.match(f), h = /\/\/instagram.com\/p\/(.[a-zA-Z0-9]*)/, i = c.match(h), j = /\/\/vine.co\/v\/(.[a-zA-Z0-9]*)/, k = c.match(j), l = /\/\/(player.)?vimeo.com\/([a-z]*\/)*([0-9]{6,11})[?]?.*/, n = c.match(l), o = /.+dailymotion.com\/(video|hub)\/([^_]+)[^#]*(#video=([^_&]+))?/, p = c.match(o), q = /\/\/v\.youku\.com\/v_show\/id_(\w+)\.html/, r = c.match(q);
            if (g && 11 === g[2].length) {
                var s = g[2];
        ...
        this.fontSize = function (a, b) {
            ...
            d(a), b.stylePara(m.create(), {"lineHeight": c})
            ...
            a(j).attr({"href": f, "target": h ? "_blank" : ""}), i = m.createFromNode(j), i.select()
            ...
            d(a), c.css({"width": a.width() * b + "px", "height": ""})
        ...
        var c = a(window), d = a(document), f = a("html, body"), i = new o, l = new r, m = new s, n = new t, q = new u, v = function (b) {
            ...
            "showLinkDialog": function (a) {
                ...
                j ? (e.data("orgheight", e.css("height")), c.on("resize", function () {
                    i({"w": c.width(), "h": c.height() - d.outerHeight()})
            ...
            if (h.isControlSizing(b.target)) {
                ...
                d.on("mousemove", function (a) {
                    i.resizeTo({
                        "x": a.clientX - o.left,
                        "y": a.clientY - (o.top - p)
                    }, l, !a.shiftKey), n.update(e, {"image": k}, q), m.update(f, {"image": k}, q)
